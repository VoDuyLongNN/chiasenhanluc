...
<head>
    ...
    <title>Nguồn Nhân Lực</title>
</head>

<body>
    <?php require_once './mvc/views/Pages/Header.php';
          require_once './mvc/views/Pages/Breadscrumb.php'
    ?>
    <section class="containt">
        ...
        <div class="containt-right">
            <ul class="list__individual list__individual--articlePersonally">

            </ul>

            <div class="MainProduct__Pagination MainProduct__Pagination--Personally">
    ...
    listMenuItem.forEach((item) => {
        if (item.innerText === 'Nguồn Nhân Lực')
